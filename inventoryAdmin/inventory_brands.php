...
$totalQuery = "SELECT COUNT(*) AS total FROM brands WHERE item_id = ?";
...
// Fetch paginated records for brands
$sql = "
    SELECT 
        id, 
        name, 
        ...
        <div class="page-content">
            <div class="content-container">
                <h2 class="page-title">
                    ...
                    Item Brands
                    <span>for <?php echo htmlspecialchars($itemName); ?></span>
                </h2>

                <!-- Back Button -->
                <div style="margin-bottom: 20px;">
                    <a href="inventory.php" class="addButton1" style="text-decoration: none;">
                            ...
                            <?php if (!empty($brands)): ?>
                                <?php foreach ($brands as $brand): ?>
                                    <tr data-id="<?php echo $brand['id']; ?>">
                                        ...
                                        <td><?php echo htmlspecialchars($brand['quantity']); ?></td>
                                        <td><?php echo htmlspecialchars($brand['origin_quantity']); ?></td>
                                        <td>
                                            <button
                                                onclick="window.location.href='inventory_items.php?id=<?php echo $brand['id']; ?>'"
                                                class="addButton" style="width: 5rem;">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="addButton1" onclick="deleteBrand(<?php echo $brand['id']; ?>)">
        ...
        function deleteBrand(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Make an AJAX request to delete the brand and its associated item quantities
                    fetch(`./endpoints/delete_brand.php?id=${id}`)
