...
<head>
    ...
    <link rel="stylesheet" href="/dionSe/assets/css/announcement.css">
            ...
            <div class="container">
                ...
                <div class="searchContainer">
                    ...
                    <div class="printButton" style="gap: 1rem; display: flex; width: 90%;">
                        ...
                        <button onclick="addProgram()" class="addButton size">Add Announcements</button>
                    </div>
                </div>
            ...
            <div class="subAddContainer">
                ...
                <div class="subLoginContainer">
                    ...
                    <div class="inputContainer" style="height: 10rem;">
                        <textarea class="inputEmail" name="" id="" placeholder="Content"></textarea>
                    </div>
